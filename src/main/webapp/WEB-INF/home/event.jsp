      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">이벤트 페이지 입니다~!</h1>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="about-img-box">
            <img src="../resources/img/slide-about-1.jpg" alt="" class="img-fluid">
          </div>
          <div class="sinse-box">
            <h3 class="sinse-title">저랑 친구입니다 ㅎㅎ
              <span></span>
              <br> ㅎㅅㅎ</h3>
            <p>Art & Creative</p>
          </div>
        ...
        <div class="col-md-4">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="../resources/img/agent-7.jpg" alt="" class="img-d img-fluid">
            </div>
